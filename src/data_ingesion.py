...
def preprocess_data(df:pd.DataFrame)->pd.DataFrame :
    ...
    try :
        ...
        logger.debug("Missing column in dataframe %s",e )
        raise
    except Exception as e :
        logger.debug("Unexpected error during preprocessing %s",e)
        raise
...
def save_data(train_data:pd.DataFrame,test_data:pd.DataFrame,data_path:str )->None :
    ...
    try :
        ...
        logger.debug("Unexpected erro while saving the data  %s",e)
        raise
